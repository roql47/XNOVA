...
exports.PlanetModule = PlanetModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: planet_schema_1.Planet.name, schema: planet_schema_1.PlanetSchema }]),
            (0, common_1.forwardRef)(() => user_module_1.UserModule),
            message_module_1.MessageModule,
        ],
        controllers: [planet_controller_1.PlanetController],
        providers: [planet_service_1.PlanetService],
        exports: [planet_service_1.PlanetService, mongoose_1.MongooseModule],
    })
], PlanetModule);
